...
--nnoremap <F2> :w!<CR> " F2: save openfile.
--inoremap <F2> <ESC>:w!<CR> " F2: save openfile.
--nnoremap <C-s> :w!<CR> " F2: save openfile.
--inoremap <C-s> <ESC>:w!<CR> " F2: save openfile.
keymap.set("i", "<F2>", '<ESC>:w!<CR><INS>')
keymap.set("i", "<C-s>", '<ESC>:w!<CR><INS>')
